        ...
        when (targetScreen) {
            ...
            AppState.LOCATION_CONFIRMATION.name -> {
                IncidentReportScreen(
                    ...
                    threatLatitude = uiState.threatLatitude,
                    threatLongitude = uiState.threatLongitude,
                    threatRadiusMeters = uiState.threatRadiusMeters,
                    threatZones = uiState.threatZones,
                    serverRecommendedAction = uiState.serverRecommendedAction,
                    liveUpdates = uiState.liveUpdates,
                    conversationMessages = uiState.conversationMessages,
                    sourceEstimate = uiState.sourceEstimate,
                    firstAidSteps = uiState.firstAidSteps,
